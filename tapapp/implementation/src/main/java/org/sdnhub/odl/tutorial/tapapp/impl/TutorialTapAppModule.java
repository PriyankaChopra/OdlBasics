...
public class TutorialTapAppModule extends AbstractTutorialTapAppModule {
    ...
    public java.lang.AutoCloseable createInstance() {
        ...
        Preconditions.checkNotNull(notificationProviderService);

        TutorialTapProvider tapProvider = new TutorialTapProvider(dataBrokerService, notificationProviderService, rpcProviderRegistry);
