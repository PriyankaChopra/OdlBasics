...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "tryNotification";
    private final String namespace = "urn:tryNotification";
    private final String revision = "2016-05-25";
    private final String resourcePath = "/META-INF/yang/tryNotification.yang";
