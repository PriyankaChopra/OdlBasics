...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "rpcYang";
    private final String namespace = "urn:rpcYang";
    private final String revision = "2016-05-24";
    private final String resourcePath = "/META-INF/yang/tryRpc.yang";
