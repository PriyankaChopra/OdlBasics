...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "tryTransaction";
    private final String namespace = "urn:tryTransaction";
    private final String revision = "2016-05-22";
    private final String resourcePath = "/META-INF/yang/tryTransaction.yang";
